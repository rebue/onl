 ...
 */
public class DeleteCartAndModifyInventoryRo {
	...
	public DeleteCartAndModifyInventoryRo() {
		super();
	}

	public DeleteCartAndModifyInventoryRo(long cartId, long onlineId, String onlineSpec, int buyCount) {
		super();
		this.cartId = cartId;
