 ...
 * 1: 上线
 */
public enum OnlineStateDic implements EnumBase {
     ...
     */
    @JsonCreator
    public static OnlineStateDic getItem(final int code) {
        final EnumBase result = valueMap.get(code);
        if (result == null) {
            throw new IllegalArgumentException("输入的code" + code + "不在枚举的取值范围内");
        }
        return (OnlineStateDic) result;
    }
