 ...
 */
public enum GoodsOnlineDic implements EnumBase {
     ...
     */
    @JsonCreator
    public static GoodsOnlineDic getItem(final int code) {
        final EnumBase result = valueMap.get(code);
        if (result == null) {
            throw new IllegalArgumentException("输入的code" + code + "不在枚举的取值范围内");
        }
        return (GoodsOnlineDic) result;
    }
