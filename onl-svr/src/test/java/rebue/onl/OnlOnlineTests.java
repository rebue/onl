 ...
 * @author daniel
 * @version 1.0
 * @since JDK 1.8 文件名称：OnlOnlineTest.java 类说明：商品上线、推广测试
 */
...
//    @Test
    public void onlineTest() throws JsonParseException, JsonMappingException, IOException {
        ...
        slideshowMap.put("slideshow",
                "slideshow=/damaiSlideshow/2018/11/08/16/06/84D0945253F8493AB2106C13F19EE92C.png");
...
//		onlineSpecTo.setCashbackAmount(new BigDecimal("121"));
        ...
        onlineSpecTo.setCurrentOnlineCount(new BigDecimal("122"));
...
//    @Test
    public void selectOnlineSpecTest() throws IOException {
        final String url  = hostUrl + "/onl/onlinespec?pageNum=" + 1 + "&pageSize=" + 5 + "&onlineId="
                + "454092105233596416";
        final String list = OkhttpUtils.get(url);
        System.out.println(list);
    }
...
//	@Test
    public void test01() throws IOException {
        ...
        specTo.setBuyCount(new BigDecimal("2"));
    ...
    private Ro updateOnlineAfterOrder(final UpdateOnlineAfterOrderTo to) throws IOException {
        ...
        final Ro ro = _objectMapper
                .readValue(OkhttpUtils.putByJsonParams(hostUrl + "/onl/online/updateonlineafterorder", to), Ro.class);
        _log.info("获取到返回值: {}", ro);
        return ro;
    }
