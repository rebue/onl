...
public class OnlOnlineSvcImpl extends MybatisBaseSvcImpl<OnlOnlineMo, java.lang.Long, OnlOnlineMapper> implements OnlOnlineSvc {
    ...
    public AddOnlineRo addOnline(final AddOnlineTo to) {
        ...
        if (to.getOnlineName() == null || to.getOnlineName().equals("") || to.getGoodsQsmm() == null || to.getGoodsQsmm().equals("") || to.getOnlineSpecs().size() == 0 || to.getSlideshow().size() == 0 || to.getSupplierId() == null || to.getDeliverOrgId() == null) {
    ...
    public ReOnlineRo reOnline(final AddOnlineTo to) {
        ...
        if (to.getOnlineId() == null || to.getOnlineName() == null || to.getOnlineName().equals("") || to.getGoodsQsmm() == null || to.getGoodsQsmm().equals("") || to.getOnlineSpecs().size() == 0 || to.getSlideshow().size() == 0 || to.getSupplierId() == null || to.getDeliverOrgId() == null) {
