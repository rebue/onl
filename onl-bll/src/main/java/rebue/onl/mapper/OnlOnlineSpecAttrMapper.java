...
public interface OnlOnlineSpecAttrMapper extends MybatisBaseMapper<OnlOnlineSpecAttrMo, Long> {
	 ...
	 * @return
	 */
	@Delete("delete from ONL_ONLINE_SPEC_ATTR where ONLINE_SPEC_ID = #{onlineSpecId,jdbcType=BIGINT}")
	int deleteByOnlineSpecId(@Param("onlineSpecId") Long onlineSpecId);
}
